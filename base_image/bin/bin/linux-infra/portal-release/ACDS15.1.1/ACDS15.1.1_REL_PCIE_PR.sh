...
#	push_tag $TAG angstrom-socfpga	angstrom-v2014.12-socfpga_gsrd15.1
#	push_tag $TAG angstrom-socfpga

#	push_tag $TAG linux-refdesigns	socfpga-15.1
#	push_tag $TAG linux-refdesigns

	push_tag $TAG linux-socfpga		socfpga-4.1
...
#	push_tag $TAG meta-altera	angstrom-v2014.12-yocto1.7
	...
	push_tag $TAG meta-altera-refdes gsrd-15.1
#	push_tag $TAG meta-altera-refdes

#	push_tag $TAG uboot-socfpga	socfpga_v2014.10_arria10_bringup
