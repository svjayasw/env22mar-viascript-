...
git tag rel_socfpga-3.16_14.11.01_rc2 rel_socfpga-3.16_14.11.01_rc1
git log --pretty=oneline -1 rel_socfpga-3.16_14.11.01_rc1
git log --pretty=oneline -1 rel_socfpga-3.16_14.11.01_rc2
echo

git tag rel_socfpga-3.10-ltsi_14.11.01_rc2 rel_socfpga-3.10-ltsi_14.11.01_rc1
git log --pretty=oneline -1 rel_socfpga-3.10-ltsi_14.11.01_rc1
git log --pretty=oneline -1 rel_socfpga-3.10-ltsi_14.11.01_rc2
echo

git tag rel_socfpga-3.10-ltsi-rt_14.11.01_rc2 rel_socfpga-3.10-ltsi-rt_14.11.01_rc1
...
git tag rel_socfpga_v2013.01.01_14.11.01_rc2 rel_socfpga_v2013.01.01_14.11.01_rc1
...
git tag rel_danny-altera_14.11.01_rc2 rel_danny-altera_14.11.01_rc1
...
git tag rel_angstrom-v2012.12-socfpga_14.11.01_rc2 rel_angstrom-v2012.12-socfpga_14.11.01_rc1
...
git tag rel_angstrom-v2013.12-socfpga_14.11.01_rc2 rel_angstrom-v2013.12-socfpga_14.11.01_rc1
...
git tag rel_angstrom-v2014.06-socfpga_14.11.01_rc2 rel_angstrom-v2014.06-socfpga_14.11.01_rc1
...
git tag rel_angstrom-v2012.12-yocto1.3_14.11.01_rc2 rel_angstrom-v2012.12-yocto1.3_14.11.01_rc1
...
git tag rel_angstrom-v2013.12-yocto1.5_14.11.01_rc2 rel_angstrom-v2013.12-yocto1.5_14.11.01_rc1
...
git tag rel_angstrom-v2014.06-yocto1.6_14.11.01_rc2 rel_angstrom-v2014.06-yocto1.6_14.11.01_rc1
...
git tag rel_master_14.11.01_rc2 rel_master_14.11.01_rc1
...
git tag rel_tags_v1_14.11.01_rc2 rel_tags_v1_14.11.01_rc1
