...
function tag_tag()
{
    ...
    if [ -z "$ref" ]; then
	echo "need to specify ref to tag against"
	exit
    fi
...
declare -r A10_TAG="$(echo $TAG | sed 's/REL_GSRD/REL_A10_GSRD/')"
...
#	tag_tag $TAG meta-altera        8d6e9b468630aa4d9d4c946080f5023dea43d891
#	tag_tag $TAG angstrom-socfpga   0a2c33dbc636dc02049cfb77f73132d70b36c183
#	tag_tag $TAG linux-socfpga	28bac3edbcdc74f98b865986be5d340381896192
#	tag_tag $TAG meta-altera-refdes 660224209baf74937656cc7d6be92fa7d2765acb
#	tag_tag $TAG uboot-socfpga	7dd0473e47ede9fd240969846a42f5646f565ce9
#	tag_tag $TAG linux-refdesigns   89acc83e9e3a66920e7bf949c60a9898419e946b
...
# uboot-socfpga
# 7dd0473e47ede9fd240969846a42f5646f565ce9
