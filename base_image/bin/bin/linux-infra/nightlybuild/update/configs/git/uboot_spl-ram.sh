...
SPL_CONFIG_UPDATES="CONFIG_PRELOADER_BOOT_FROM_QSPI=0,CONFIG_PRELOADER_BOOT_FROM_SDMMC=0,CONFIG_PRELOADER_BOOT_FROM_NAND=0,CONFIG_PRELOADER_BOOT_FROM_RAM=1"
LATEST_NAME="uboot-${MACHINE}-spl-ram"
